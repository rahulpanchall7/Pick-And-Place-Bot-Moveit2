...
public:
    ...
    {
        service_ = create_service<pickbot_msgs::srv::AddTwoInts>("add_two_ints", std::bind(&SimpleServiceServer::serviceCallback, this, _1, _2));
        RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Service add_two_ints is ready");

    }
private:
    rclcpp::Service<pickbot_msgs::srv::AddTwoInts>::SharedPtr service_;

    void serviceCallback(const std::shared_ptr<pickbot_msgs::srv::AddTwoInts::Request> req,
                        const std::shared_ptr<pickbot_msgs::srv::AddTwoInts::Response> res)
    {
