...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pickbot_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from pickbot_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from pickbot_msgs.srv._add_two_ints import AddTwoInts_Response as Response
