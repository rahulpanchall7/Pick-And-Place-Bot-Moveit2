...
#include "pickbot_msgs/srv/detail/quaternion_to_euler__rosidl_typesupport_fastrtps_c.h"
...
using _QuaternionToEuler_Request__ros_msg_type = pickbot_msgs__srv__QuaternionToEuler_Request;
...
size_t get_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Request(
  const void * untyped_ros_message,
...
static uint32_t _QuaternionToEuler_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pickbot_msgs
size_t max_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pickbot_msgs__srv__QuaternionToEuler_Request;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
static size_t _QuaternionToEuler_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler_Request)() {
...
using _QuaternionToEuler_Response__ros_msg_type = pickbot_msgs__srv__QuaternionToEuler_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pickbot_msgs
size_t get_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _QuaternionToEuler_Response__ros_msg_type * ros_message = static_cast<const _QuaternionToEuler_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pickbot_msgs
size_t max_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs__srv__QuaternionToEuler_Response;
    is_plain =
      (
...
static size_t _QuaternionToEuler_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pickbot_msgs__srv__QuaternionToEuler_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler_Response)() {
...
// already included above
// #include "pickbot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "pickbot_msgs/srv/quaternion_to_euler.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler)() {
