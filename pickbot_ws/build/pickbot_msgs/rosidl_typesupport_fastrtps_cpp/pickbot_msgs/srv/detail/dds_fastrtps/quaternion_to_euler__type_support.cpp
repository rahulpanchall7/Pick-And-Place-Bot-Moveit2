...
#include "pickbot_msgs/srv/detail/quaternion_to_euler__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pickbot_msgs::srv::QuaternionToEuler_Request;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::srv::QuaternionToEuler_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pickbot_msgs::srv::QuaternionToEuler_Request *>(
    untyped_ros_message);
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::srv::QuaternionToEuler_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::srv::QuaternionToEuler_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::srv::QuaternionToEuler_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Response__handle;
}
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler__handle;
}
