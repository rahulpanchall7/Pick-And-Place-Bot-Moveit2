...
#include "pickbot_msgs/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pickbot_msgs::srv::AddTwoInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::srv::AddTwoInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pickbot_msgs::srv::AddTwoInts_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pickbot_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, srv, AddTwoInts_Request)() {
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::srv::AddTwoInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::srv::AddTwoInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::srv::AddTwoInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, srv, AddTwoInts_Response)() {
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, srv, AddTwoInts)() {
  return &pickbot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
