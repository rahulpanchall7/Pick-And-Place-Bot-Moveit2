...
#include "pickbot_msgs/action/detail/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_Goal & ros_message)
{
  // Member: order
  cdr >> ros_message.order;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pickbot_msgs::action::Fibonacci_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_Goal)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sequence
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_Result & ros_message)
{
  // Member: sequence
  {
    cdr >> ros_message.sequence;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_Result)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_Feedback & ros_message)
{
  // Member: partial_sequence
  {
    cdr >> ros_message.partial_sequence;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_Feedback)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
// functions for pickbot_msgs::action::Fibonacci_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pickbot_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_SendGoal_Request)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_SendGoal_Response)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_SendGoal)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_GetResult_Request)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for pickbot_msgs::action::Fibonacci_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pickbot_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_GetResult_Response)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_GetResult)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
// functions for pickbot_msgs::action::Fibonacci_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pickbot_msgs
cdr_serialize(
  const pickbot_msgs::action::Fibonacci_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pickbot_msgs::action::Fibonacci_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pickbot_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pickbot_msgs::action::Fibonacci_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pickbot_msgs::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pickbot_msgs::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pickbot_msgs, action, Fibonacci_FeedbackMessage)() {
  return &pickbot_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
