...
static const _QuaternionToEuler_Request_type_support_symbol_names_t _QuaternionToEuler_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pickbot_msgs, srv, QuaternionToEuler_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pickbot_msgs, srv, QuaternionToEuler_Request)() {
  return &::pickbot_msgs::srv::rosidl_typesupport_c::QuaternionToEuler_Request_message_type_support_handle;
}
...
static const _QuaternionToEuler_Response_type_support_symbol_names_t _QuaternionToEuler_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pickbot_msgs, srv, QuaternionToEuler_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pickbot_msgs, srv, QuaternionToEuler_Response)() {
  return &::pickbot_msgs::srv::rosidl_typesupport_c::QuaternionToEuler_Response_message_type_support_handle;
}
...
static const _QuaternionToEuler_type_support_symbol_names_t _QuaternionToEuler_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pickbot_msgs, srv, QuaternionToEuler)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pickbot_msgs, srv, QuaternionToEuler)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pickbot_msgs, srv, QuaternionToEuler)() {
  return &::pickbot_msgs::srv::rosidl_typesupport_c::QuaternionToEuler_service_type_support_handle;
}
