...
#define NODE_MAIN_LOGGER_NAME "task_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtask_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pickbot_remote::TaskServer>";
